...
<body class="">
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <!-- Brand -->
      <a class="navbar-brand pt-0" href="<?php echo base_url('index.html')?>">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <a class=" nav-link " href=" <?php echo site_url('dashboard')?>"> <i class="ni ni-tv-2 text-primary"></i> Dashboard
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="#navbar-kuliah" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-kuliah">
            ...
            <div class="collapse" id="navbar-kuliah">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="" class="nav-link">Pengaturan Mata Kuliah</a>
                  </li>
                  <li class="nav-item">
                    <a href="" class="nav-link">Pengaturan Jadwal</a>
                  </li>
                  <li class="nav-item">
                    <a href="" class="nav-link active">Pengaturan Kelas</a>
                  </li>
                  <li class="nav-item">
                    <a href="" class="nav-link">Pengaturan Mahasiswa Mata Kuliah</a>
                  </li>
                </ul>
              </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="navbar-laporan">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="../../pages/examples/pricing.html" class="nav-link">Presensi Mahasiswa</a>
                  </li>
                  <li class="nav-item">
                    <a href="../../pages/examples/login.html" class="nav-link">Data Mahasiswa per Mata Kuliah</a>
                  </li>
                  <li class="nav-item">
                    <a href="../../pages/examples/register.html" class="nav-link">Data Mata Kuliah per Mahasiswa</a>
                  </li>
                  <li class="nav-item">
                    <a href="../../pages/examples/lock.html" class="nav-link">Jadwal Kuliah</a>
                  </li>
                  <li class="nav-item">
                    <a href="../../pages/examples/timeline.html" class="nav-link">Daftar Kelas</a>
                  </li>
                </ul>
              </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="navbar-akademisi">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="../../pages/examples/pricing.html" class="nav-link">Data Dosen</a>
                  </li>
                  <li class="nav-item">
                    <a href="../../pages/examples/login.html" class="nav-link">Data Mahasiswa</a>
                  </li>
                </ul>
              </div>
          </li>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="<?php echo base_url('index.html')?>"> Pengaturan Kelas</a>
        <!-- Form -->
