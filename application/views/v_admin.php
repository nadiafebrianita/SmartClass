              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <tr>
                    ...
                    <button type="button" class="btn btn-sm btn-outline-danger" data-toggle="modal" data-target="#modal-notification<?php echo $u->id_admin; ?>">Hapus</button>

                    <div class="modal fade" id="modal-notification<?php echo $u->id_admin; ?>" tabindex="-1" role="dialog" aria-labelledby="modal-notification" aria-hidden="true">
